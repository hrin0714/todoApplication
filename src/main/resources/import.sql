...
insert into k_todo_list (todo_id, what_todo, insert_date, status, dbsts) values (1,'회사가기',      	CURRENT_TIMESTAMP(),'I', 'N');
...
insert into k_todo_list (todo_id, what_todo, insert_date, status, dbsts) values (9,'페이징 처리 개발',      	CURRENT_TIMESTAMP(),'C', 'N');
insert into k_todo_list (todo_id, what_todo, insert_date, status, dbsts) values (10,'오류 해결',		CURRENT_TIMESTAMP(),'I', 'N');
insert into k_todo_list (todo_id, what_todo, insert_date, status, dbsts) values (11,'인텔리J 사용해보기',      	CURRENT_TIMESTAMP(),'C', 'N');
insert into k_todo_list (todo_id, what_todo, insert_date, status, dbsts) values (12,'셀프셀렉트 미노출 제약',	CURRENT_TIMESTAMP(),'C', 'N');
insert into k_todo_list (todo_id, what_todo, insert_date, status, dbsts) values (13,'교차 참조 제약',	CURRENT_TIMESTAMP(),'C', 'N');
insert into k_todo_list (todo_id, what_todo, insert_date, status, dbsts) values (14,'Unit 테스트',	CURRENT_TIMESTAMP(),'I', 'N');
insert into k_todo_list (todo_id, what_todo, insert_date, status, dbsts) values (15,'Git 소개서작성',	CURRENT_TIMESTAMP(),'C', 'N');
